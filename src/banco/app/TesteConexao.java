...
public class TesteConexao extends JFrame {
    ...
    private void criarConta() {
        ...
        btnCriar.addActionListener(e -> {
            ...
            String tipoContaSelecionado = (String) comboTipoConta.getSelectedItem();
            ...
            JOptionPane.showMessageDialog(frameConta, "Conta " + tipoContaSelecionado + " criada com sucesso!");
            frameConta.dispose();
        });
    }
